      ...
      <div className="relative mx-auto max-w-7xl px-6 py-14 lg:py-16">
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-10">
          <div className="lg:col-span-4">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-slate-400">
              Plan safer, smarter trips—culture tips, routes, stays, and dining
              ideas built for travelers who care about respect, comfort, and
              clarity.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              >
                <span aria-hidden>✉️</span> kanishkajaswal18@gmail.com
              </a>
            </div>
          </div>
          ...
          <div className="grid gap-10 sm:grid-cols-3 lg:col-span-8 lg:grid-cols-3">
            ...
            <div>
              ...
              <p className="mt-6 text-xs leading-relaxed text-slate-500">
                Tools and suggestions are for planning only. Always verify
                bookings, visas, and safety with official sources before you
                travel.
              </p>
            </div>
          </div>
        ...
        <div className="mt-14 flex flex-col gap-4 border-t border-white/10 pt-8 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-slate-500">
            © {new Date().getFullYear()} Solosphere. Crafted for thoughtful
            travelers.
          </p>
          <p className="text-xs text-slate-600">
            Made with care · Travel smart · Stay curious
          </p>
        </div>
      </div>
    </footer>
